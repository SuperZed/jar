package com.plugin.library.view.dialog;
...
public class MaterialDialog extends Dialog implements View.OnClickListener {
    ...
    private int BTN_COLOR_PRESSED = 0x73e7e7e7;
    ...
    private void initView() {
        ...
        rl_buttons = (LinearLayout) this.findViewById(R.id.rl_buttons);
        ...
        if (!wrapper.showNegativeButton || TextUtils.isEmpty(wrapper.btTextNo)) {
            btn_no.setVisibility(View.GONE);
        }
        if (!wrapper.showPositiveButton || TextUtils.isEmpty(wrapper.btTextYes)) {
        ...
        btn_yes.setBackgroundDrawable(getStateListDrawable(getContext(), 0, BTN_COLOR_PRESSED, 0x00000000));
        btn_no.setBackgroundDrawable(getStateListDrawable(getContext(), 0, BTN_COLOR_PRESSED, 0x00000000));
    ...
    private static class Wrapper {
        ...
        public int cornerRadiusDp = 5;
        public int dividerMarginHorizontalDp = 12;
        public int primaryTextColor = 0xff2196F3;
    ...
    public static class Builder {
        ...
        public Builder setPositiveButtonMultiListener(CharSequence text, final OnMultiClickListener btMultiListenerYes) {
            wrapper.btMultiListenerYes = btMultiListenerYes;
            wrapper.btTextYes = text;
            return this;
        }

        public Builder setPositiveButtonMultiListener(int textId, final OnMultiClickListener btMultiListenerYes) {
            wrapper.btMultiListenerYes = btMultiListenerYes;
            wrapper.btTextYes = wrapper.context.getText(textId);
            return this;
        }
        ...
        public Builder setNegativeButtonMultiListener(CharSequence text, final OnMultiClickListener btMultiListenerNo) {
            wrapper.btMultiListenerNo = btMultiListenerNo;
            wrapper.btTextNo = text;
            return this;
        }
        ...
        public MaterialDialog create() {
            final MaterialDialog dialog = new MaterialDialog(wrapper.context);
