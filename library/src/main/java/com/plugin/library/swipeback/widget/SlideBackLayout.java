package com.plugin.library.swipeback.widget;
...
//        mCacheDrawView.setBackgroundColor(Color.parseColor("#990000"));
        addView(mCacheDrawView);

        mShadowView = new ShadowView(getContext());
        mShadowView.setVisibility(INVISIBLE);
        addView(mShadowView, mScreenWidth, LayoutParams.MATCH_PARENT);
