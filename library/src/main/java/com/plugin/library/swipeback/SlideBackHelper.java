package com.plugin.library.swipeback;
...
import com.plugin.library.swipeback.callbak.OnInternalStateListener;
...
public class SlideBackHelper {
    ...
    public static SlideBackLayout attach(@NonNull final Activity curActivity, @NonNull final ActivityHelper helper,
                                         @Nullable final SlideConfig config, @Nullable final OnSwipeListener listener) {
